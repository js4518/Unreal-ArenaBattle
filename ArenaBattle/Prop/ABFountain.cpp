...
AABFountain::AABFountain()
{
	...
	Body = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("NAME_Body"));
	Water = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("NAME_Water"));

	RootComponent = Body; // 루트 컴포넌트 설정 필수
	Water->SetupAttachment(Body); // 자식으로 설정
